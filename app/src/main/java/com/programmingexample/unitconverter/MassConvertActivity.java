 ...
 */
public class MassConvertActivity extends AppCompatActivity {
    //Instance variables
    ...
    public void ConvertUnit(View view) { //Begin convert unit
        ...
        Double finalNumber = massConvert(number, originalUnits, newUnits);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.mnu_invert:
                ...
                break;
            case R.id.mnu_about:
                android.support.v7.app.AlertDialog.Builder builder = new android.support.v7.app.AlertDialog.Builder(MassConvertActivity.this, R.style.AppTheme_Dialog_Green);
                builder.setCancelable(false);
                builder.setIcon(R.mipmap.mass);
                builder.setTitle("Mass Converter");
                builder.setMessage("You can convert between Milligram [mg], Gram [g], Kilogram [kg], Metric ton [t] and Pound [lb].\n");
                // Add the buttons0
                ...
                break;
            case R.id.mnu_exit:
                android.support.v7.app.AlertDialog.Builder quit = new android.support.v7.app.AlertDialog.Builder(MassConvertActivity.this, R.style.AppTheme_Dialog_Green);
    ...
    { //Begin massConvert
        ...
        { //Begin of conversion table
            ...
            { //Begin converting from
                ...
                {
                    case "Milligram [mg]":
                        num2 = originalNum * 453592;
                        break;
                    case "Gram [g]":
                        num2 = originalNum * 453.592;
                        break;
                    case "Kilogram [kg]":
                        num2 = originalNum * 0.453592;
                        break;
                    case "Metric ton [t]":
                        num2 = originalNum * 0.000453592;
                        break;
                    case "Pound [lb]":
                        num2 = originalNum;
                        break;
