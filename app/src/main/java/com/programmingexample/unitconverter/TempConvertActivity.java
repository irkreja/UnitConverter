...
public class TempConvertActivity extends AppCompatActivity {
    ...
    public void ConvertUnit(View view) { //Begin convert unit
        ...
        Double finalNumber = tempConvert(number, originalUnits, newUnits);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.mnu_invert:
                ...
                break;
            case R.id.mnu_about:
                android.support.v7.app.AlertDialog.Builder builder = new android.support.v7.app.AlertDialog.Builder(TempConvertActivity.this, R.style.AppTheme_Dialog_Green);
                builder.setCancelable(false);
                builder.setIcon(R.mipmap.tmp);
                builder.setTitle("Temperature Converter");
                builder.setMessage("You can convert between Celsius, Fahrenheit and Kelvin.");
                // Add the buttons0
                ...
                break;
            case R.id.mnu_exit:
                android.support.v7.app.AlertDialog.Builder quit = new android.support.v7.app.AlertDialog.Builder(TempConvertActivity.this, R.style.AppTheme_Dialog_Green);
