 ...
 */
public class FrequencyConvertActivity extends AppCompatActivity {
    //Instance variables
    ...
    public void ConvertUnit(View view) { //Begin convert unit
        ...
        Double finalNumber = frequencyConvert(number, originalUnits, newUnits);
    ...
    public void setSpinnerItems() {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this,
                R.array.frequency_units, android.R.layout.simple_spinner_item);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.mnu_invert:
                ...
                break;
            case R.id.mnu_about:
                android.support.v7.app.AlertDialog.Builder builder = new android.support.v7.app.AlertDialog.Builder(FrequencyConvertActivity.this, R.style.AppTheme_Dialog_Green);
                builder.setCancelable(false);
                builder.setIcon(R.mipmap.frequency);
                builder.setTitle("Frequency Converter");
                builder.setMessage("You can convert between Hertz (Hz), Kilohertz (kHz), Megahertz (MHz) and Gigahertz (GHz).");
                // Add the buttons0
                ...
                break;
            case R.id.mnu_exit:
                android.support.v7.app.AlertDialog.Builder quit = new android.support.v7.app.AlertDialog.Builder(FrequencyConvertActivity.this, R.style.AppTheme_Dialog_Green);
    ...
    public double frequencyConvert(double originalNum, String originalUnit, String desiredUnit)
    { //Begin frequencyConvert
        ...
        { //Begin of conversion table
            case "Hertz (Hz)":
            { //Begin converting from Hertz (Hz)
                switch(newU)
                {
                    case "Hertz (Hz)":
                        num2 = originalNum;
                    ...
                    case "Megahertz (MHz)":
                        ...
                        break;
                    case "Gigahertz (GHz)":
                        num2 = originalNum * 1e-9;
                        break;
                }
                break;
            } //end converting from Hertz (Hz)
            case "Kilohertz (kHz)":
            { //Begin converting from Kilohertz (kHz)
                switch(newU)
                {
                    case "Hertz (Hz)":
                ...
                break;
            } //end converting from Kilohertz (kHz)
            case "Megahertz (MHz)":
            { //Begin converting from Megahertz (MHz)
                switch(newU)
                {
                    case "Hertz (Hz)":
                        num2 = originalNum * 1e+6;
                ...
                break;
            } //end converting from Megahertz (MHz)
            case "Gigahertz (GHz)":
            { //Begin converting from Gigahertz (GHz)
                switch(newU)
                {
                    case "Hertz (Hz)":
                        num2 = originalNum * 1e+9;
                ...
                break;
            } //end converting from Gigahertz (GHz)
        } //End of conversion table

        //Return the final number, num2
        return num2;
    } //End Frequency Convert
